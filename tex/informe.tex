...
\textbf{Graduado de la UBA}\{\pkfk{id}\}

\textbf{Graduado de otra universidad}\{\pkfk{id}, inicioActividades\}

\textbf{Profesor}\{\pkfk{id}, nacionalidadUniversidad\}

\textbf{Profesor regular}\{\pkfk{id}, \fk{nacionalidadUniversidad}\}
